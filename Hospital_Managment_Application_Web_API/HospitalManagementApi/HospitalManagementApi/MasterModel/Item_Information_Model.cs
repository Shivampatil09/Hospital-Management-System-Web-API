...
namespace _1_Hospital_Managment_Model.MasterModel
{
    public class Item_Information_Model
    {
        ...
        public int item_is_stockebal { get; set; }
        public int item_quality_check { get; set; }
        public int item_return_policy { get; set; }
        ...
        public int item_tax_apply { get; set; }
